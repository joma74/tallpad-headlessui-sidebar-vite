  ...
  <div class="relative py-8">
    ...
    >
      <header class="px-4 pt-6 prose-sm md:px-6 md:prose">
        <h1>
          Vite + Vue 3 + TypeScript + Tailwind + Playwright Starter Template v{{
            VERSION
          }}
        </h1>
        <p class="pb-4 text-xl leading-relaxed tracking-wide text-gray-700">
          Opinionated, production ready template for Vite and Vue 3. MIT
          licensed,
          <a href="https://github.com/Uninen/vite-ts-tailwind-starter"
      ...
      <main>
        <div class="p-4 mx-auto prose md:px-6 prose-indigo sm:rounded-md">
          ...
          <ul>
            <li>
              Pinia store (fully typed Vuex store available in version 1.13)
            </li>
            <li>Routing using vue-router</li>
            <li>
              TailwindCSS w/ JIT-mode, purge, plugins, and production
              minimization pre-configured
            </li>
            <li>
              Vue-friendly Eslint and Prettier configuration - use as is or
            ...
            <li>
              Github Workflows preconfigured to run e2e and component tests
          ...
          <p>
            ...
            >
            is recommended to take full advance of the new script setup sugar
            and full TypeScript support in Vue SFC templates. (This is totally
            optional but recommended as it results much better DX!) See
            <a
          ...
          <pre>yarn test_ct</pre>

          <h4>Run e2e tests (Playwright)</h4>

          <pre>yarn test_e2e</pre>
          ...
          <p>
            Vite exposes a special <code>meta.env</code> object for ENV
            variables (see
            <a href="https://vitejs.dev/guide/env-and-mode.html"
              >official docs</a
            >). This template extends that object and adds custom typed
            variables which you can easily use and modify to your needs.
          </p>

          <p>
            See <code>vite.config.js</code> and
            <code>src/shims-vue-router.d.ts</code> for the configuration and
            <code>src/pages/IndexPage.vue</code> for usage example.
          </p>

          <h3>Custom `firefox` variant for Tailwind</h3>

          <p>
            FireFox is important browser to the open Web. One of the very few
            things it still doesn't do is
            <a href="https://caniuse.com/css-backdrop-filter"
              ><em>backdrop-filter</em> CSS property</a
            >. The included <code>tailwind.config.js</code> has a custom plugin
            that allows you to use a <strong>'firefox' variant</strong> in your
            Tailwind markup to target FireFox. The setup uses Tailwind JIT mode
            and PurgeCSS so this doesn't add any weight to your CSS if you don't
            use it. But, it's there if you happen to need it!
          </p>
...
&lt;/div&gt;</pre
          ...
          <p>
            TL;DR: due to Vite and esbuild design decisions and ongoing work in
            this area, code coverage is not yet added to this template.
          </p>

          <p>
            I have a fully configured Vue 3 + TypeScript + Cypress + Coverage
            reporting + GitLab and GitHub CI `vue-cli` template project
            available at
            <a href="https://gitlab.com/uninen/vue-cli-template"
              >https://gitlab.com/uninen/vue-cli-template</a
            >. That's a real world example of proper coverage configuration that
            works automatically in CI. But. This setup doesn't work with Vite.
          </p>

          <p>
            Typical Vite pipelines don't use babel at all which is needed above
            for automatically instrument the transpilated code. Vite is powered
            by eslint which has decided
            <a href="https://github.com/evanw/esbuild/issues/184">
              code coverage being out of scope </a
            >. Vitest can be configured to produce code coverage as well but
            that only counts unit tests.
          </p>
          ...
          <ul>
            <li>
              Follow <a href="https://twitter.com/uninen">@Uninen on Twitter</a>
            </li>
            <li>
              Lots of continuously updating learnings from Vite / Vue /
              TypeScript and other Web development topics on my
